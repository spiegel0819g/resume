...
\role{Brief introduction: Import Face detection in door security system of company. Employee can enter office and clock in/out directly without using identification card.}
Achievement:
\begin{itemize}
  \item Optimized bla bla bla...
\end{itemize}
