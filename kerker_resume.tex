...
\role{AI Cam} {}
Brief introduction: We collaborate with AI Cam team. We help developing object detection feature.
\begin{itemize}
  \item Collected data and data cleansing 
  \item Analyzed different models performance on datasets
  \item Research SSD mobile model and YOLO model performance
\end{itemize}
\role{Home Surveillance} {}
Brief introduction: Import Face detection in door security system of company. Employee can enter office and clock in/out directly without using identification card.
\begin{itemize}
  \item Integrated the current door security system and Face detection server
  \item Optimized model by Graph transform tool, SNPE sdk
  \item Implemented open door automatically with Raspberry Pi and Relay
...
\begin{itemize}
  \item Designed model by Tensorflow, Keras
  \item Developed app by Tensorflow's android API 
\end{itemize}
