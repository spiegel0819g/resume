...
\item Achievement:
\begin{itemize}
  \item It can be used in actual that the time consuming of recognition is about 60$\sim$200ms with qualcomm snapdragon 625
\end{itemize}
...
\item Achievement:
\begin{itemize}
  \item Enhance 15\% accuracy by adding black padding and not changing the ratio of input picture on 6000 staffs dataset
\end{itemize}
\item Task description:
\begin{itemize}
...
\role{\underline{ZenUI Launcher}} {https://goo.gl/vBQkv1}
\begin{description}
\item Brief introduction:\\
