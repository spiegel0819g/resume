...
{\parindent=2em Brief introduction:}\\
{\parindent=4em Collaborate with AI Cam team. We help developing object detection feature.}\\
{\parindent=2em Achievement:}\\
\begin{itemize}
  \item Optimized bla bla bla...
\end{itemize}
{\parindent=2em Task description:}\\
\begin{itemize}
